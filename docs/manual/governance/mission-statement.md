...
- **@ngrx/signals** Signal Store for reactive state management
...
DA-Bubble is a fully functional, real-time chat application
with a modern Angular 21 stack and Firebase backend. Open source, self-hosted,
production-stable, documented for learning purposes.

## Target Audience

- **End users:** Teams looking for a Discord alternative
- **Developers:** Learners who want to see Angular + Firebase in production
- **Architects:** Reference for Signals, store patterns, responsive design
